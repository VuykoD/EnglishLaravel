...
<div class="video-responsive">
 ...
 <div class="span5"><a class="btn btn-info btn-large centered_menu_3 margin_b_7" id="new_training1">Тренировать</a> </div>
                    <div class="span1"></div>
                        <div class="btn-group">
...
<p align="center" class="input2 size_30 "><button class="btn btn-inverse btn-large btn_input2"></button></p>
<p align="center" class="input" id="focus"></p>
<p align="center" class="microphon"><input type="password" class="speech-input" placeholder="Нажмите Enter" id="microphon2"></p>
...
$video_ = $('#video');
src = $video_.attr('src');
arr_English=[@foreach ($video_time as $list)"{{$list['eng']}}",@endforeach]
...
arr_Rus=[@foreach ($video_time as $list)'{{$list['rus']}}',@endforeach]
