...
@guest
   @else
              <text class = "xp padding_r_30 pull-left" id="learnt">Изучено</text>
              <div class = "pull-left" >  <img src="images/game/defender/2.png" class="defender_footer "></div>
              <div class = "pull-left" >  <img src="images/game/defender/4.png" class="defender_footer"></div>
              <div class = "xp exp pull-left" > <text >Уровень - 12</text></div>
              ...
              <div class = "xp sec_ pull-left" > <text  class="time_game" id="time_game">3600</text>  </div>            
@endguest
            <div class=" disabled">
