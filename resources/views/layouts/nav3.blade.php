                    ...
                    <div class="navbar">
                        ...
                        <div>
                            <ul class="nav nav-pills ddmenu">
                               <li class="dropdown">
                                    <a href="#about.html" class="dropdown-toggle"><br><b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                                        <li disabled><a href="#full.html" class="disabled" disabled>Моя школа</a></li>
                    ...
                    <div class="navbar ">
                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav nav-pills ddmenu">
                                ...
                                <li class="dropdown ">
                                    <a class="dropdown-toggle">Школа<br><b class="caret"></b></a>
                                    <ul class="dropdown-menu ">
                                                        <li><a href="#full.html">Раннее развитие</a></li>
                                                        ...
                                                        <li class="dropdown">
                                                          <a class="dropdown-toggle">3-ий класс &nbsp;&raquo;</a>
                                                              <ul class="dropdown-menu sub-menu">
                                                                 <li><a href="courses.php?course=3_Ukraine_2017">Украина</a></li>
                                                                 <li><a href="#">Россия</a></li>
                                                            </ul>
                                                        </li> 
